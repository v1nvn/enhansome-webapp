/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 782244877317e9f4d9c1a3e43317e595)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		INDEXING_WORKFLOW: Workflow<Parameters<import("./src/server").IndexingWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_API_KEYS">> {}
}
