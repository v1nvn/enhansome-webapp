...
export function RegistryLayout({
  ...
  return (
    <div className="bg-background flex h-full flex-col">
      ...
      <div className="bg-background/80 px-4 py-4 shadow-sm backdrop-blur-xl sm:px-6">
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="flex-1">
            <SearchBar onTagsChange={onTagsChange} />
          </div>
          {total > 0 && (
            <div className="bg-muted/60 flex shrink-0 items-center gap-2 rounded-xl px-4 py-2 shadow-sm">
      ...
      {hasNextPage && (
        <div className="bg-background/80 px-4 py-4 shadow-sm backdrop-blur-xl sm:px-6">
          <div className="flex items-center justify-center">
            <button
              className="from-primary to-primary/90 text-primary-foreground shadow-primary/20 hover:shadow-primary/30 group inline-flex cursor-pointer items-center gap-2 rounded-xl bg-gradient-to-br px-6 py-3 text-sm font-semibold shadow-lg transition-all hover:scale-105 hover:shadow-xl active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100"
